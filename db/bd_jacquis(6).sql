...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 02-12-2023 a las 19:31:29
...
ALTER TABLE `producto`
  ...
  ADD KEY `producto_talla_id_talla_fk` (`id_talla`),
  ADD KEY `producto_marca_id_marca_fk` (`id_marca`);
...
ALTER TABLE `producto`
  ...
  ADD CONSTRAINT `producto_marca_id_marca_fk` FOREIGN KEY (`id_marca`) REFERENCES `marca` (`id_marca`),
  ADD CONSTRAINT `producto_proveedor_id_proveedor_fk` FOREIGN KEY (`id_proveedor`) REFERENCES `proveedor` (`id_proveedor`),
  ADD CONSTRAINT `producto_talla_id_talla_fk` FOREIGN KEY (`id_talla`) REFERENCES `talla` (`id_talla`);
